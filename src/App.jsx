    ...
    {/* ---------- Expérience section ---------- */}
      ...
      <Section id="tableau">
        <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          <div className="bg-slate-800/40 p-4 sm:p-6 rounded-xl border border-white/10">
            <a href="/public/Tableau de synthese E4.pdf" download className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded bg-pink-600/60 hover:bg-pink-600/80 transition text-xs sm:text-sm">
