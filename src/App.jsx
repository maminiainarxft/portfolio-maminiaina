        ...
        {zoomedImage && (
          ...
          >
            ...
            <motion.div 
              ...
              animate={{ scale: 1 }}
              exit={{ scale: 0.95 }}
              className="w-full max-w-6xl h-[85vh] bg-[#131B2F] rounded-2xl overflow-hidden border border-white/10 shadow-2xl relative"
            ...
            >
              {zoomedImage.toLowerCase().endsWith('.pdf') ? (
                ...
                <img src={zoomedImage} alt="Aperçu agrandi" className="w-full h-full object-contain p-2" />
              )}
            </motion.div>
          </motion.div>
        )}
          ...
          <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <button onClick={() => setZoomedImage('Exemple Deploiement de software.png')} className="ml-8 inline-flex items-center gap-2 text-xs font-medium bg-pink-500/10 hover:bg-pink-500/20 text-pink-300 px-3 py-2 rounded-lg transition-colors border border-pink-500/20 w-fit">
            ...
            <div className="group bg-[#131B2F] p-6 sm:p-10 rounded-3xl border border-white/5 hover:border-pink-500/20 transition-all hover:-translate-y-1 shadow-xl relative overflow-hidden">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button onClick={() => setZoomedImage('Exemple ticket ANATOMS.png')} className="ml-8 inline-flex items-center gap-2 text-xs font-medium bg-pink-500/10 hover:bg-pink-500/20 text-pink-300 px-3 py-2 rounded-lg transition-colors border border-pink-500/20 w-fit">
